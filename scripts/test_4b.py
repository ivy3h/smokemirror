#!/usr/bin/env python3
"""
Test script for Smokemirror with Qwen3-4B model.
"""
...
def main():
    """Run full test with Qwen3-4B."""
    logger.info("=" * 60)
    logger.info("SMOKEMIRROR TEST - Qwen3-4B")
    logger.info("=" * 60)
    ...
    from src.data_structures.facts import StoryState
    ...
    logger.info(f"Cover story: {fabricated_facts.cover_story[:150]}...")
    ...
    # Strip any remaining think tags from the story
    ...
    output_dir = project_root / "outputs" / f"test_4b_{run_id}"
